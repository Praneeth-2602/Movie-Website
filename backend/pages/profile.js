            ...
            <div className="profilesettings">
                <div className="leftprofile_details flex">
                    ...
                    <div className="w-100">
                        <div className="flex flex-sb flex-left mt-2">
                            <h2>My Profile</h2>
                            <h3>Praneeth Palugula <br />Web Developer</h3>
                        </div>
                        <div className="flex flex-sb flex-left mt-2">
                            <h3>Phone:</h3>
                            <input type="text" defaultValue='+91 85550 33466' />
                        </div>
                        <div className="mt-3">
                            <input type="email" defaultValue='praneeth.palugula@gmail.com' />
                        </div>
                ...
                <div className="rightlogoutsec">
                    <div className="topaccoutnbox">
                        <h2 className="flex flex-sb">Mym Account <MdOutlineAccountCircle /></h2>
                        <hr />
